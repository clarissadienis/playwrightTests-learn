...
class OrangeHRMLoginTest {
    ...
    async waitForLoginForm() {
        try {
            ...
            console.error('❌ Login form elements not found:', error.message);
    ...
    async verifySuccessfulLogin() {
        try {
            ...
            if (loginSuccessful) {
                ...
                console.log('❌ Login verification failed - dashboard not found');
    ...
    async verifyFailedLogin() {
        try {
            console.log('🔍 Verifying failed login...');
            ...
            for (const selector of errorSelectors) {
                try {
                    ...
                    if (errorElement) {
                        ...
                        console.log(`✅ Login failed as expected. Error: ${errorText}`);
            ...
            console.error('❌ Error verifying failed login:', error.message);
            return false;
        }
    }
...
test.describe('OrangeHRM Login Tests', () => {
    ...
    test('should login successfully with valid credentials', async () => {
        ...
        console.log('✅ TEST PASSED: Successful login completed');
    });
    ...
    test('should fail login with invalid username', async () => {
        ...
        console.log('✅ TEST PASSED: Invalid username test completed');
    });
    ...
    test('should fail login with invalid password', async () => {
        ...
        console.log('✅ TEST PASSED: Invalid password test completed');
    });
    ...
    test('should handle empty credentials', async () => {
        ...
        console.log('✅ TEST PASSED: Empty credentials test completed');
    });
});
